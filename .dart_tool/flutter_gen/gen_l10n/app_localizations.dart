...
abstract class AppLocalizations {
  ...
  /// No description provided for @insertAction.
  ///
  /// In pt, this message translates to:
  /// **'Inserir'**
  ...
  /// No description provided for @insertDeviceId.
  ///
  /// In pt, this message translates to:
  /// **'Insira id de dispositivo'**
  ...
  /// No description provided for @familiar.
  ///
  /// In pt, this message translates to:
  /// **'familiar'**
  String get familiar;
  ...
  /// No description provided for @familiars.
  ///
  /// In pt, this message translates to:
  /// **'familiares'**
  String get familiars;

  /// No description provided for @healthProfessionals.
  ///
  /// In pt, this message translates to:
  /// **'profissionais de saúde'**
  String get healthProfessionals;

  /// No description provided for @institutionAdministrators.
  ///
  /// In pt, this message translates to:
